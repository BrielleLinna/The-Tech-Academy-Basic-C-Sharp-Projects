    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y " || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\Brielle\Documents\Logs\log.txt", true))
                {
        ...
        private static void UpdateDbWithException(Exception ex)
        {
            ...
            string queryString =@"INSERT INTO dbo (ExceptionType, ExceptionMessage, TimeStamp) VALUES
                (@ExceptiType, @ExceptionMessage, @TimeStamp)";
        ...
        private static List<ExceptionEntity> ReadExceptions()
        {
            ...
            string queryString = @"Select.Id, ExceptionType, ExceptionType, ExceptionMessage, TimeStamp From Exceptions";
